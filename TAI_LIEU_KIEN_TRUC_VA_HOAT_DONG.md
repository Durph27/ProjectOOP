...
| Enum | Vai trò |
|---|---|
| `Platform` | Chuẩn hóa các nguồn dữ liệu |
| `Sentiment` | Chuẩn hóa ba nhãn sentiment |
| `DamageCategory` | Chuẩn hóa danh mục thiệt hại |
| `ReliefCategory` | Chuẩn hóa danh mục cứu trợ |
